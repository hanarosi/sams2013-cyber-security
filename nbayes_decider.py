...
USAGE = '''%s <class 1 counts> <class 2 counts> >query token file>'''
...
if __name__ == '__main__':
	...
	class1log = log(float(class1count) / (class1count + class2count))
	class2log = log(float(class2count) / (class1count + class2count))
